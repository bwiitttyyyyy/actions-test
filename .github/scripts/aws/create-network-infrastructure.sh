...
aws ec2 create-tags --resources $VPC_ID --tags Key=commit,Value=$GITHUB_SHA Key=repository,Value=$REPOSITORY --profile production
...
aws ec2 create-tags --resources $PUBLIC_SUBNET_ID --tags Key=commit,Value=$GITHUB_SHA Key=repository,Value=$REPOSITORY --profile production
...
aws ec2 create-tags --resources $PRIVATE_SUBNET_1_ID --tags Key=commit,Value=$GITHUB_SHA Key=repository,Value=$REPOSITORY --profile production
...
aws ec2 create-tags --resources $PRIVATE_SUBNET_2_ID --tags Key=commit,Value=$GITHUB_SHA Key=repository,Value=$REPOSITORY --profile production
...
aws ec2 create-tags --resources $GATEWAY_ID --tags Key=commit,Value=$GITHUB_SHA Key=repository,Value=$REPOSITORY --profile production
...
aws ec2 create-tags --resources $PUBLIC_ROUTE_TABLE_ID --tags Key=commit,Value=$GITHUB_SHA Key=repository,Value=$REPOSITORY --profile production
...
#aws ec2 create-tags --resources $PRIVATE_ROUTE_TABLE_ID --tags Key=commit,Value=$GITHUB_SHA Key=repository,Value=$REPOSITORY --profile production
